			...
			<article id="post-22" class="post-22 screen type-screen status-publish hentry condition-depression">
				<div class="wrap normal">
					...
					<div class="page-heading plain">
						<h1 class="entry-title">Tentukan Bakat Anak</h1>
					</div>
				</div>
					...
					<div class="page-intro">
						<div class='gf_browser_safari gform_wrapper gform_legacy_markup_wrapper' id='gform_wrapper_1'
							...
							<<div class='gform_heading'>
								<h3 class="gform_title">Cek bakat</h3> <span class='gform_description'></span>
							</div>
...
<li id="field_{{ $loop->iteration }}" class="gfield question gfield_contains_required field_sublabel_below field_description_above gfield_visibility_visible" data-js-reload="field_{{ $loop->iteration }}">
	<label class='gfield_label'>{{ $loop->iteration }}. {{ $item->gejala }}?<span class="gfield_required"><span class="gfield_required gfield_required_asterisk">*</span></span></label>
...
@endforeach
    ...
    <button type="button" class='gform_next_button button' onclick='submitForm()'>Submit</button>
    {{-- <a href="/form-faq" class='gform_cancel_button button'>Batal</a> --}}
</div>

<script>
    function submitForm() {
        // Tambahkan kode JavaScript yang diperlukan untuk mengirimkan formulir
