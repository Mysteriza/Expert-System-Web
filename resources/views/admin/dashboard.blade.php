              ...
              <div class="row">
                ...
                <div class="col-xxl-4 col-md-6">
                  <div class="card info-card sales-card">
                    ...
                    <div class="card-body">
                      <h5 class="card-title">Daftar <span>| Indikator</span></h5>
                      ...
                      <div class="d-flex align-items-center">
                        ...
                        <div class="ps-3">
                          <h6>{{$gejala->count()}}</h6>
                          <span class="text-success small pt-1 fw-bold">{{$gejala->count()}}</span> <span class="text-muted small pt-2 ps-1">indikator</span>
