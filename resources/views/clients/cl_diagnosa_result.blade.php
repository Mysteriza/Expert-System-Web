            ...
            <div class="col-md-10 mx-auto">
                <div class="card my-4">
                    ...
                    <div class="card-body">
                      ...
                      <p class="card-text">Jadi dapat disimpulkan bahwa bakat yang diperoleh dengan tingkat kepastian yaitu <span class="fw-semibold fs-4">{{ round(($hasil["value"] * 100), 2) }}</span> %</p>
